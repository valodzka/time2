...
About 12-21 times faster than TZInfo, but could be even faster if you use <code>local</code> instead of <code>getlocal</code> which creates a new object every time
<pre>
...
About 10-50 times faster than <code>strptime</code> from the ruby standard library (we use <code>Method#call</code> to avoid redefinition)
...
* how should %N work?
* whether %Q be implemented?

h3. TODO

* <code>strptime</code> implementation doesn't support some special flags
* <code>stftime</code> on some platforms doesn't display %Z correctly
