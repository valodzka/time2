...
h5. Why library doesn't use system "tz database":http://www.twinsun.com/tz/tz-link.htm ?
...
* <code>strptime</code> implementation doesn't support some special flags (%W, %u)
