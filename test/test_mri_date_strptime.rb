...
=begin
  ...
  def test_strptime__ex
    assert_raise(ArgumentError) do
      Time.strptime('2001-02-29', '%F')
    end
    assert_raise(ArgumentError) do
      Time.strptime('2001-02-29T23:59:60', '%FT%T')
    end
    assert_raise(ArgumentError) do
